...
SECRET_KEY = 'django-insecure-50e4ljggnj^8=o)u#bd)1z%qai6kv$rgill25^u3wgbqr@fgwb'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'apps.theme.context_processors.yanleaf_settings',
            ],
        },
    },
]
...
CAPTCHA_FOREGROUND_COLOR = '#2d3436'
